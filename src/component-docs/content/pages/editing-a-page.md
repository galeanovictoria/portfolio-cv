...
Now that you can edit pages, let's make the site your own. Head to [Customizing Your Brand](/component-docs/customizing-your-brand/) to learn how design tokens shift colors, fonts, and spacing across every component at once.
